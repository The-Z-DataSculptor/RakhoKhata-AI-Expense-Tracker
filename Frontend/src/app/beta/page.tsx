...
/* ==========================================================================
   ...
   ========================================================================== */
import React from "react"; // Required for JSX in some TypeScript / linter setups
    ...
    <main className={styles.pageContainer}>
      <div className={styles.contentCard}>
        ...
        <p className={styles.subtitle}>
          We are putting the final touches on this page right now. In the
          meantime, our entire application is <strong>100% free</strong> for
          early users. Create an account today and start organizing your
          money in seconds.
        </p>

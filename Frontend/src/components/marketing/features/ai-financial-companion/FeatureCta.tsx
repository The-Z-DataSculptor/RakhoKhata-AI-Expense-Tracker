/* D:\Developer\Expense-Tracker\Frontend\src\components\marketing\features\ai-financial-companion\FeatureCta.tsx */
...
export default function FeatureCta({
  ...
  return (
    <section className={styles.ctaSection} aria-label="Start Using AI Buddy Call To Action">

// src/components/marketing/features/budget-planner/FeatureBenefits.tsx
"use client";
...
export default function FeatureBenefits({
  ...
  return (
    <section className={styles.benefitsSection} aria-label="Budget Planner Benefits">
      <div className={styles.container}>
        
        {/* HEADER BLOCK */}
        <div className={styles.headerBlock}>
          <span className={styles.pillLabel}>The Old Way vs. The Smart Way</span>

// D:\Developer\Expense-Tracker\Frontend\src\components\marketing\features\budget-planner\FeatureHero.tsx // 
...
const TRUST_TAGS = [
  "Visual Donut Progress Rings",
  "80% Warning Color Alerts",

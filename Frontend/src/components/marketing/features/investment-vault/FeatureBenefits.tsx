...
export default function FeatureBenefits({
  ...
  return (
    <section className={styles.benefitsSection} aria-label="Investment Vault Benefits">
      <div className={styles.container}>
        {/* HEADER BLOCK */}
        <div className={styles.headerBlock}>
          <span className={styles.pillLabel}>The Old Way vs. The Vault Way</span>

...
import { FiShield, FiPlusCircle, FiTrendingUp } from "react-icons/fi";
...
const STEP_ICONS = [
  <FiShield key="w-1" size={22} />,
  <FiPlusCircle key="w-2" size={22} />,
  <FiTrendingUp key="w-3" size={22} />,
];
...
export default function FeatureWorkflow({
  ...
  return (
    <section className={styles.workflowSection} aria-label="How Investment Vault Works in 3 Steps">

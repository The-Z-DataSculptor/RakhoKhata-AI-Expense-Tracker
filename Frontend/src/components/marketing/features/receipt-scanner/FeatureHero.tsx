//src/components/marketing/features/receipt-scanner/FeatureHero.tsx
...
const TRUST_TAGS = [
  ...
  "Camera Shutter & PDF Ingestion",
  "Auto-Currency Normalization",
  "Free Core Tier",
] as const;
...
export default function FeatureHero({
  ...
  return (
    <section className={styles.heroSection} aria-label="AI Receipt Scanner Introduction">
